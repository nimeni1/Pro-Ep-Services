package client.service.db;

import client.service.models.Fare;
import client.service.serializer.JsonSerializer;
...
public class Database {
    ...
    public String findDocumentId(MongoCollection<Document> collection, Map<String,Object> json) {
        String result;
        FindIterable<Document> documents = collection.find(new BasicDBObject(json));
        Document document = documents.first();
        ...
        if (obj != null) {
            ...
            throw new MongoException("No Id found");
        }
        return result;
    }
